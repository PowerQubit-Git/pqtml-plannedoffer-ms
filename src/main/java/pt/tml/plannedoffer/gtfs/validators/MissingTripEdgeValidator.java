...
import static pt.powerqubit.validator.core.table.GtfsStopTimeTableLoader.ARRIVAL_TIME_FIELD_NAME;
import static pt.powerqubit.validator.core.table.GtfsStopTimeTableLoader.DEPARTURE_TIME_FIELD_NAME;
...
public class MissingTripEdgeValidator extends FileValidator
{
    ...
    {
        for (Map.Entry<String, List<GtfsStopTime>> entry :
